 ...
 * https://github.com/Microsoft/ELL/blob/master/libraries/utilities/src/Files.cpp
 *
...
namespace ell
{
    namespace utilities
    {
        ...
        std::string JoinPaths(const std::string& path, const std::initializer_list<std::string> toAdd)
        {
